...
public class EvaluateTemplateTask
{
    ...
    public Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        var configFiles = new[]
        {
            ...
            FsPath.Join(Paths.UserConfigDirectory, "casa.yaml"),
        ...
        {
            checksumEntries.Add(new ChecksumEntry()
            {
                Path = kvp.Key,
                Checksum = Convert.ToBase64String(kvp.Value),
            });
        }

        var json = JsonSerializer.Serialize(checksumEntries, new JsonSerializerOptions()
        {
            WriteIndented = true,

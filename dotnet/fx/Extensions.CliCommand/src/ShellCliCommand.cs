...
public abstract class ShellCliCommand : CliCommand
{
    ...
    {
        ["deno"] = typeof(Deno.DenoCommand),
        ["node"] = typeof(NodeJs.NodeJsCommand),
        ["python"] = typeof(Python.PythonCommand),
        ["ruby"] = typeof(Ruby.RubyCommand),
        ["bash"] = typeof(Bash.BashCommand),
        ["sh"] = typeof(Sh.ShCommand),
        ["pwsh"] = typeof(Pwsh.PwshCommand),
        ["powershell"] = typeof(PowerShell.PowerShellCommand),
        ["cmd"] = typeof(WinCmd.WinCmdCommand),
    };
    ...
    {
        var fileName = FsPath.RandomFileName();

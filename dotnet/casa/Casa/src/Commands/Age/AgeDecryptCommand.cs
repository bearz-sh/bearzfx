...
public class AgeDecryptCommand : AgeBaseCommand
{
    public AgeDecryptCommand()
        : base("decrypt", "Decrypt the input file")
    {
    }
}

[SuppressMessage("ReSharper", "UnusedAutoPropertyAccessor.Global")]
public class AgeDecryptCommandHandler : ICommandHandler
{

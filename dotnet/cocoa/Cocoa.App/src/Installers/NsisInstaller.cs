...
// source: https://github.com/chocolatey/choco/blob/develop/src/chocolatey/infrastructure.app/domain/installers/NsisInstaller.cs
...
{
    public NsisInstaller(ILogger<NsisInstaller> logger)
        : base(logger)
    {
        ...
        this.CustomInstallLocation = $"/D={InstallTokens.CustomInstallLocation}";
    }

    public override InstallerType InstallerType => InstallerType.Nsis;
}
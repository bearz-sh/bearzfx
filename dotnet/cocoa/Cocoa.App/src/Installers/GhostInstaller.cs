...
// source: https://github.com/chocolatey/choco/blob/develop/src/chocolatey/infrastructure.app/domain/installers/GhostInstaller.cs
...
{
    public GhostInstaller(ILogger<GhostInstaller> logger)
        : base(logger)
    {
        this.SilentInstall = "-s";
        this.SilentUninstall = "-u -s";
    }

    public override InstallerType InstallerType => InstallerType.Ghost;
}
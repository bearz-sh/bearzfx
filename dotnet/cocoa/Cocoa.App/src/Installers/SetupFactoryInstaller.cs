...
// source: https://github.com/chocolatey/choco/blob/develop/src/chocolatey/infrastructure.app/domain/installers/SetupFactoryInstaller.cs
...
{
    public SetupFactoryInstaller(ILogger<SetupFactoryInstaller> logger)
        : base(logger)
    {
        ...
        this.OtherInstallOptions = null;
        this.SilentUninstall = "/S";
    }

    public override InstallerType InstallerType => InstallerType.SetupFactory;
}
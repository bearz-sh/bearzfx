...
// source: https://github.com/chocolatey/choco/blob/release/2.0.0/src/chocolatey/infrastructure/adapters/IProcess.cs
...
public interface IProcess : IDisposable
{
    ...
    /// <summary>
    ///   Gets or sets a value indicating whether the <see cref='System.Diagnostics.Process.Exited' /> event is fired when the process terminates.
    /// </summary>
    /// <value>
    ...
    /// <returns><see langword="true" /> if the program has exited; otherwise <see langword="false" />.</returns>

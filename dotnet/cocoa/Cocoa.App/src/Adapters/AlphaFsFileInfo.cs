...
public class AlphaFsFileInfo : IFileInfo
{
    private readonly Alphaleonis.Win32.Filesystem.FileInfo fileInfo;

    private IDirectoryInfo? directory;

    public AlphaFsFileInfo(string fileName)
    {
        this.fileInfo = new Alphaleonis.Win32.Filesystem.FileInfo(fileName);
    }

    public AlphaFsFileInfo(Alphaleonis.Win32.Filesystem.FileInfo fileInfo)
    {
    ...
    public IDirectoryInfo? Directory
    {
        get
        {
            ...
            return this.directory ??= new AlphaFsDirectoryInfo(this.fileInfo.Directory);
        }
    }
    ...
    public void MoveTo(string destFileName, bool overwrite)
    {
        ...
        this.fileInfo.MoveTo(destFileName, options);
    }

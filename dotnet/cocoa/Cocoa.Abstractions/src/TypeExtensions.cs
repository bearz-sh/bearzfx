...
// source: https://github.com/chocolatey/choco/blob/release/2.0.0/src/chocolatey/TypeExtensions.cs
...
public static class TypeExtensions
{
    ...
    public static bool IsBuiltinType(this Type? type)
    {
        ...
        return type.IsPrimitive
               || type.IsValueType
               || (type == typeof(string))
               || type.Namespace?.Equals("System") == true;
    }
    ...
    public static bool IsCollectionType(this Type? type)
    {
        ...
        return type.IsArray
               || type.Namespace?.Contains("System.Collections") == true;
    }
}
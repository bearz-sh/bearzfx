...
// source: https://github.com/chocolatey/choco/blob/release/2.0.0/src/chocolatey/infrastructure.app/domain/Registry.cs
...
public class Registry
{
    ...
    {
        this.User = user;
        this.RegistryKeys = keys != null ? keys.ToList() : new List<RegistryApplicationKey>();
    }
    ...
    /// </remarks>
    [XmlArray("keys")]
    public List<RegistryApplicationKey> RegistryKeys { get;  }
}
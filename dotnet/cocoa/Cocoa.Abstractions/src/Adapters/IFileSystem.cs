...
// source: https://github.com/chocolatey/choco/blob/release/2.0.0/src/chocolatey/infrastructure/filesystem/IFileSystem.cs
...
public interface IFileSystem
{
    ...
    /// </summary>
    /// <returns>Returns the temp path.</returns>
    string GetTempPath();

    /// <summary>
    ///   Gets the path directory separator character.
    /// </summary>
    /// <returns>The path directory separator char.</returns>
    char GetPathDirectorySeparatorChar();

    /// <summary>
    /// Gets the path to an executable based on looking in current directory, next to the running process, then among
    /// the derivatives of Path and Pathext variables.
    /// </summary>
